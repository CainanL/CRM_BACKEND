...
export class UpdateCorporateClientAddressRequest {
...
export class UpdateCorporateClientRequest {
    ...
    @ApiProperty({ type: UpdateCorporateClientAddressRequest, description: "Endereço completo" })
    @IsDefined({ message: "O endereço é obrigatório" })
    @ValidateNested()
    @Type(() => UpdateCorporateClientAddressRequest)
    address: UpdateCorporateClientAddressRequest;
