...
export class UpdateCampaignRequest {
  ...
  @ApiPropertyOptional({ example: "Campanha de Energia Solar - Janeiro 2024", description: "Nome da campanha" })
  @IsString()
  @IsOptional()
  name?: string;
  ...
  @ApiPropertyOptional({ example: CampaignType.EMAIL, description: "Tipo da campanha", enum: CampaignType })
  @IsEnum(CampaignType)
  @IsOptional()
  ...
  @ApiPropertyOptional({ example: "Olá {{name}}, descubra como economizar na sua conta de luz com energia solar...", description: "Conteúdo da mensagem" })
  @IsString()
  @IsOptional()
  content?: string;
